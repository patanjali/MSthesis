...
#         return self.klucb(x, d, self.klBern, upperbound, precision)
    ...
    def computeIndex(self, arm, t):
        ...
        if self.numPlays[arm] == 0:
            ...
            #return self.klucbGauss((self.payoffSums[arm] / self.numPlays[arm]), (math.log(t / self.numPlays[arm])+self.c * math.log(math.log(t))) / self.numPlays[arm], 1e-4)
    ...
    def klucbTest(self,numActions):
        ...
        f = open('NewExpt/expt2/testRegretKLUCB01.txt', 'a')
...
if __name__ == "__main__":
    ...
    while i<=100:
        ...
        for j in range(0,100):
            ...
            f = open('NewExpt/expt2/testKLUCB01.txt', 'a')
