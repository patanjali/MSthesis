...
class EUCBV(object):
    ...
    def rewards(self,choice, timesteps):
        #Gaussain Reward
        #return random.gauss(self.means[choice],0.3)
    ...
    def upperBoundVar(self, numPlays, arm):
        vj=abs((self.sqPayOffSums[arm]/(self.numPlays[arm])) - (self.avgPayOffSums[arm]*self.avgPayOffSums[arm]))
    ...
    '''
    def upperBoundVarExp(self, numPlays, arm):
    ...
    def eUCBV(self,arms,turn,wrong):
        ...
        while True:
            ...
            for i in range(self.numActions):
                if self.B[i]!=-1:
                    ...
                    #self.ucbs[i]=self.avgPayOffSums[i] + self.upperBoundVar1(self.numPlays[i],i)
        ...
        f = open('NewExpt/expt1/testRegretEUCBV01.txt', 'a')
...
if __name__ == "__main__":
    ...
    while arms<=20:
        ...
        for turn in range(0,100):
            ...
            f = open('NewExpt/expt1/EUCBV01.txt', 'a')
