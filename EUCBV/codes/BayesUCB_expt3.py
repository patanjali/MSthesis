    ...
    def ucb1(self,numActions):
        ...
        while True:
            ...
            if self.timestep%1000==0:
                print self.timestep,regret,str(max(range(self.numActions), key=lambda i: self.arm_reward[i])),str("expt4")
        ...
        f = open('NewExpt/expt3/testRegretBU01.txt', 'a')
...
if __name__ == "__main__":
    ...
    while i<=100:
        ...
        for turn in range(100):
            ...
            f = open('NewExpt/expt3/testBU01.txt', 'a')
