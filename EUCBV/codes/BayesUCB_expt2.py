    ...
    def ucb1(self,numActions):
        ...
        while True:
            ...
            if self.timestep%1000==0:
                print self.timestep,regret,str(max(range(self.numActions), key=lambda i: self.arm_reward[i]))
        ...
        f = open('NewExpt/expt2/testRegretBU011.txt', 'a')
...
if __name__ == "__main__":
    ...
    while i<=100:
        ...
        for turn in range(100):
            ...
            f = open('NewExpt/expt2/testBU011.txt', 'a')
