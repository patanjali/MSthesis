...
class MOSS(object):
    ...
    def upperBound(self, step, numPlays):
        ...
        #print math.sqrt(max(math.log((self.numRounds)/(self.numActions*numPlays)),0.0) / numPlays)
        '''
        try:
            return math.sqrt(max(math.log((self.numRounds)/(1.0*self.numActions*numPlays)),0.0) / numPlays)
        except Exception as err:
            print (self.numRounds)/(self.numActions*numPlays)
            print(format(err))
        '''
    ...
    def moss(self,numActions):
        ...
        f = open('NewExpt/expt5/testRegretMOSS01.txt', 'a')
...
if __name__ == "__main__":
    ...
    while i<=100:
        ...
        for j in range(turn,100):
            ...
            f = open('NewExpt/expt5/testMOSS01.txt', 'a')
