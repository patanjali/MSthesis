...
class ucbV(object):
    ...
    def upperBound(self, step, numPlays,payoffSums,sqpayoffSums):
        ...
        #print vj
        return (math.sqrt((2.0*vj*math.log(step+1))/numPlays)+math.log(step+1)/numPlays)
    ...
    def ucb1(self,numActions):
        ...
        #self.variance[self.bestAction]=0.3
        ...
        f = open('NewExpt/expt2/testRegretUCBV01.txt', 'a')
...
if __name__ == "__main__":
    ...
    while i<=100:
        ...
        for j in range(100):
            ...
            f = open('NewExpt/expt2/testUCBV01.txt', 'a')
