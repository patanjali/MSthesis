...
\State \For{$i\in\A$}
\State \If{$\hat{r}_{i,t_0:t_p} + \sqrt{\dfrac{\alpha\log(\psi T\epsilon_m^2)}{2n_{i,t_0:t_p}}}  < j\in\argmax_{i\in\A}\lbrace\hat{r}_{i,t_0:t_p} - \sqrt{\dfrac{\alpha\log(\psi T\epsilon_m^2)}{2n_{i,t_0:t_p}}}\rbrace$}
