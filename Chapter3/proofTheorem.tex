...
We first present a few technical lemmas that are required to prove the result in Theorem \ref{Result:Theorem:1}. 

In Lemma \ref{proofTheorem:Lemma:1} we use the constraint on the horizon, that is $T\geq K^{2.4}$ to derive an inequality which we re-use in Lemma \ref{proofTheorem:Lemma:2} to bound the length of the confidence interval $c_i$ of the $i$-th sub-optimal arm till the $m_i$-th round.
...
In Lemma \ref{proofTheorem:Lemma:2} we bound the length of the confidence interval $c_i$ for the $i$-th arm till the $m_i$-th round.
...
\begin{align*}
	c_{i} &\leq \sqrt{\dfrac{\rho (\hat{v}_i + 2)\epsilon_{m_{i}}\log (\psi T\epsilon_{m_{i}})}{2\log(\psi T\epsilon_{m_{i}}^{2})}} \\
	%%%%%%%%%%%%%%%%%%%%%%%%%%
	&\overset{(a)}{\leq} \sqrt{\dfrac{2\rho\epsilon_{m_{i}}\log (\frac{\psi T\epsilon_{m_{i}}^{2}}{\epsilon_{m_{i}}})}{\log(\psi T\epsilon_{m_{i}}^{2})}} \\
	%%%%%%%%%%%%%%%%%%%%%%%%%%
...
In Lemma \ref{proofTheorem:Lemma:3} we bound the probability of the deviation of the sample mean $\hat{r}_i$ from its expectation $r_i$ till the $m_i$-th round.
...
In Lemma \ref{proofTheorem:Lemma:4} we bound the probability of the confidence interval of the optimal arm $c^*$ being greater than the confidence interval $c_i$ of the $i$-th sub-optimal arm till the $m_i$-th round.
...
In Lemma \ref{proofTheorem:Lemma:5} we bound the probability of the number of pulls of the $i$-th sub-optimal arm, $z_i$, of not being greater then the allocated $n_{m_i}$ number of pulls till the $m_i$-th round.
...
In Lemma \ref{proofTheorem:Lemma:6} we prove the inequality required to introduce the variance term in the number of pulls of a sub-optimal arm $i$ till the $m_i$-th round.
...
%The proofs of lemmas \ref{proofTheorem:Lemma:1} - \ref{proofTheorem:Lemma:6} can be found in Appendix ~\ref{App:Lemma:1}, ~\ref{App:Lemma:2}, ~\ref{App:Lemma:3}, ~\ref{App:Lemma:4}, ~\ref{App:Lemma:5} and ~\ref{App:Lemma:6} respectively.
...
Also, for eq. $(\ref{eq:arm:elim:c1})$ we can show that for any $\epsilon_{m_i}\in\left[\sqrt{\frac{e}{T}},1\right]$
\begin{eqnarray}
\bigg(\dfrac{4}{(\psi T\epsilon_{m_{i}})^{\frac{3\rho}{2}}} \bigg) &\overset{(a)}{\leq} \bigg(\dfrac{4}{(\frac{T^2}{K^2}\epsilon_{m_{i}})^{\frac{3}{4}}} \bigg)
%%%%%%%%%%%%%%%%%%%%%%%
\leq \bigg(\dfrac{4 K^{\frac{3}{2}}}{(T^\frac{3}{2} \epsilon_{m_i}^{\frac{1}{4}}\sqrt{\epsilon_{m_{i}}})}\bigg) \nonumber \\
%%%%%%%%%%%%%%%%%%%%%%%
